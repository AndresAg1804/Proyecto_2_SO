...
class MessageBrokerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Publish = channel.unary_unary(
                ...
                response_deserializer=message__broker__pb2.Empty.FromString,
...
def add_MessageBrokerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Publish': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=message__broker__pb2.Empty.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('MessageBroker', rpc_method_handlers)
...
class MessageBroker(object):
    ...
    def Publish(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            message__broker__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
